...
double coefficient_threshold[] = {0.95, 0.9, 0.87, 0.94, 0.9, 0.95, 0.94, 0.95, 0.919, 0.925, 0.95,
                                  0.94};  //coefficients for different colors
...
////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    switch (main_menu) {
        case 1:{
            ...
            int end_vertex, num_vertex;
            if (menu == 1) {
                cout << "Which peak are we going to?" << endl;
                cin >> end_vertex;
                cout << "How many peaks?" << endl;
                cin >> num_vertex;
            }
...
////////////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            while (window.isOpen()) {
                ...
                switch (menu) {
                    case 1: {
                        graph1.SearchOstov(window, 2, num_vertex);
                        graph1.DepthSearch(window, 3, end_vertex);
                    }
                        break;
                    case 2: {
...
////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    std::string img_path = argv[1], templ_path = argv[2];
            ...
            std::vector<unsigned> figure_number;
            std::vector<std::vector<std::pair<double, double>>> figure(num_color_templ);
            std::vector<compressed_matrix<bool>> figure_compressed;
            ...
            for (int i = 0; i < num_color_templ; i++) {
                ...
                std::vector<std::vector<bool>> figure_matrix(figure[i].size());
                for (int j = 0; j < figure[i].size(); j++) {
            ...
            std::vector<std::vector<compressed_matrix<int>>> all_figures(figure_num);
            ...
            std::vector<compressed_matrix<int>> result;
            for (int i = 0; i < figure_num; i++) {
